...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "beta_computer_for_broyden = poly_approx_control.beta_computer_for_broyden:main",
            "beta_computer_for_poly_approx = poly_approx_control.beta_computer_for_poly_approx:main",
